...
public:
	...
	uint8_t Inquire[8] = {0x55, 0x07, 0x09, 0x00, 0x00, 0x00,0x09,0xBB}; // 烽火台 关闭
	uint8_t Inquire_1[8] = { 0x55, 0x06, 0x43, 0x00, 0x00, 0x00,0x43,0xBB }; // 烽火台 关闭
	...
	uint8_t State_of_the_terrain[8] = { 0x55, 0x10, 0x10, 0x01, 0x00, 0x00, 0x11, 0xBB};
	...
	//uint8_t TFT_Time_Close the timing[8] = {0x55,0x0B,0x30,0x00,0x00,0x00,0x30,0xBB};//TFT关闭计时
	//uint8_t TFT_Time_Open the timing[8] = { 0x55,0x0B,0x30,0x01,0x00,0x00,0x31,0xBB };//TFT开启计时
	//uint8_t TFT_Time_Reset the timer[8] = { 0x55,0x0B,0x30,0x02,0x00,0x00,0x32,0xBB };//TFT清零计时
...
extern void YY_Play_Zigbee_2(uint8_t* p);
extern _Drive Drive;
