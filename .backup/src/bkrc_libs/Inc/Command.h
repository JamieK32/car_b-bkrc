...
public:
	...
	uint8_t command02[ 8 ] = { 0x55,0x03,0x01 ,0x01 ,0x00 ,0x00 ,0x00 ,0xbb };	/*打开命令					不修改*/
	...
	uint8_t TrafficC_Open[8] = { 0x55,0x13,0x01,0x00,0x00,0x00,0x01,0xBB };		// 智能交通灯C 进入识别模式 进入识别模式
	uint8_t TrafficC_Red[8] = { 0x55,0x13,0x02,0x01,0x00,0x00,0x03,0xBB };			// 智能交通灯C 识别结果为红色请求确认 
	uint8_t TrafficC_Green[8] = { 0x55,0x13,0x02,0x02,0x00,0x00,0x04,0xBB };	// 智能交通灯C 识别结果为绿色请求确认
	uint8_t TrafficC_Yellow[8] = { 0x55,0x13,0x02,0x03,0x00,0x00,0x05,0xBB };	// 智能交通灯C 识别结果为黄色请求确认

	uint8_t TrafficD_Open[8] = { 0x55,0x14,0x01,0x00,0x00,0x00,0x01,0xBB };		// 智能交通灯D 进入识别模式 进入识别模式
	uint8_t TrafficD_Red[8] = { 0x55,0x14,0x02,0x01,0x00,0x00,0x03,0xBB };			// 智能交通灯D 识别结果为红色请求确认 
	uint8_t TrafficD_Green[8] = { 0x55,0x14,0x02,0x02,0x00,0x00,0x04,0xBB };	// 智能交通灯D 识别结果为绿色请求确认
	uint8_t TrafficD_Yellow[8] = { 0x55,0x14,0x02,0x03,0x00,0x00,0x05,0xBB };	// 智能交通灯D 识别结果为黄色请求确认
